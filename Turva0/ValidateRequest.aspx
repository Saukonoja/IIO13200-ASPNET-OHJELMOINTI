...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div>
    ...
    nimi:<asp:TextBox ID="txtName" runat="server"></asp:TextBox>
      <asp:RegularExpressionValidator ID="myRegexValidator" runat="server" ErrorMessage="Nimessä ei voi olla erikoismerkkejä" ControlToValidate="txtName" ValidationExpression="^[A-Öa-ö_-]+$"></asp:RegularExpressionValidator>
